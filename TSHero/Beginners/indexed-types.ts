...
let carCool: TheCoolestCarEverMade = "Toyota Corolla"
let truckBonus: TruckDriverBonusGiver = 45_000_000

console.log(carCool) // "Toyota Corolla"
console.log(truckBonus) // 45000000
